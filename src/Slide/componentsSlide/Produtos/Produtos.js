...
var Produtos = () => {
  ...
  return (
    <div className="Produtos">
      <div className="ProdutosEF Produtosvoid"></div>
      ...
      <div className="ProdutosEF ProdutosInf">
        <div className="ProdutosEF2 ProdutosImgD">
          <img
            className="ProdutosEF3 ProdutosImg AEF3"
            src={img ? img : ""}
            alt="Alguma foto"
          />
        </div>
        <div className="ProdutosEF2 ProdutosDescriD AEF3">
          ...
          <div className="TabelaD">
            ...
            <p className="DescriP" id="DescriP">
              ...
              comunidade esse é o melhor casaco Cardigã que você já viu.
              Excelente de Krotor nas ilhas gregas. Compre já e receba hoje
              mesmo pela nossa entrega nossa entrega a jato.
            </p>
          </div>
        </div>
      </div>
