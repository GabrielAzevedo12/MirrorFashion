...
var DivAnimationMain = () => {
  ...
  return (
    ...
    >
      ...
      <div className="main_banner_1 displayNone main_banner_1_state_inicial">
        main banner 1
      </div>
      <div className="main_banner_2 displayNone main_banner_2_state_inicial">
        main banner 2
      </div>
      <div className="main_banner_3 displayNone main_banner_3_state_inicial">
        main banner 3
      </div>
      <div className="main_banner_4 displayNone main_banner_4_state_inicial">
        main banner 4
      </div>
      <div className="main_banner_5 displayNone main_banner_5_state_inicial">
        main banner 5
      </div>
    </div>
  );
